...
public final class GsonUtil {
    ...
    public static <T> T getClassType(Class<T> clazz) {
        return (T)(((ParameterizedType)clazz.getClass().getGenericSuperclass()).getActualTypeArguments()[0]);
    }
    ...
    public static void writeStringToFile(Context context, String name, String jsonString) {
